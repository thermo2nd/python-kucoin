...
class Client(object):
    ...
    async def _request(self, method, path, signed, **kwargs):
        ...
        if method == 'get':
            response = await self.session.get(uri, **kwargs)
        elif method == 'post':
            response = await self.session.post(uri, **kwargs)
        elif method == 'put':
            response = await self.session.put(uri, **kwargs)
        elif method == 'delete':
            response = await self.session.delete(uri, **kwargs)
        else:
    ...
    async def get_currencies(self, coins=None):
        ...
        return await self._get('open/currencies', False, data=data)

    async def set_default_currency(self, currency):
        ...
        return await self._post('user/change-currency', False, data=data)


    async def create_withdrawal(self, coin, amount, address):
        ...
        return await self._post('account/{}/withdraw/apply'.format(coin), True, data=data)

    async def cancel_withdrawal(self, coin, txid):
        """Cancel a withdrawal
        ...
        return await self._get('account/{}/withdraw/cancel'.format(coin), True, data=data)

    async def get_deposits(self, coin, status=None, limit=None, page=None):
        ...
        return await self._get('account/{}/wallet/records'.format(coin), True, data=data)

    async def get_withdrawals(self, coin, status=None, limit=None, page=None):
    ...
    async def get_coin_balance(self, coin):
        ...
        return await self._get('account/{}/balance'.format(coin), True)

    async def get_all_balances(self, limit=None, page=None):
        ...
        return await self._get('account/balance', True, data=data)
    ...
    async def create_order(self, symbol, order_type, price, amount):
        ...
        return await self._post('order', True, data=data)

    async def create_buy_order(self, symbol, price, amount):
        """Create a buy order
    ...
    async def get_active_orders(self, symbol, kv_format=False):
        ...
        return await self._get('order/active', True, data=data)

    async def cancel_order(self, symbol, order_id, order_type):
        """Cancel an order
        ...
        return await self._post('cancel-order', True, data=data)

    async def cancel_all_orders(self, symbol=None, order_type=None):
        """Cancel all orders
        ...
        return await self._post('order/cancel-all', True, data=data)

    async def get_dealt_orders(self, symbol=None, order_type=None, limit=None, page=None, since=None, before=None):
        ...
        return await self._get('order/dealt', True, data=data)

    async def get_symbol_dealt_orders(self, symbol, order_type=None, limit=None, page=None):
        ...
        return await self._get('deal-orders', True, data=data)

    async def get_order_details(self, symbol, order_type, limit=None, page=None, order_id=None):
        """Get order details
        ...
        return await self._get('{}/order/detail'.format(symbol), True, data=data)
    ...
    async def get_tick(self, symbol):
        ...
        return await self._get('open/tick', False, data=data)

    async def get_order_book(self, symbol, group=None, limit=None):
        ...
        return await self._get('open/orders', False, data=data)

    async def get_buy_orders(self, symbol, group=None, limit=None):
        ...
        return await self._get('open/orders-buy', False, data=data)

    async def get_sell_orders(self, symbol, group=None, limit=None):
        ...
        return await self._get('open/orders-sell', False, data=data)

    async def get_recent_orders(self, symbol, limit=None, since=None):
        """Get recent orders
        ...
        return await self._get('open/deal-orders', False, data=data)
    ...
    async def get_trading_symbols(self):
        ...
        return await self._get('market/open/symbols')
    ...
    async def get_trending_coins(self):
        ...
        return await self._get('market/open/coins-trending')

    async def get_kline_data(self, symbol, resolution, from_time, to_time, limit=None):
        """Get kline data
        ...
        return await self._get('open/kline', False, data=data)

    async def get_kline_config_tv(self):
        ...
        return await self._get('open/chart/config')

    async def get_symbol_tv(self, symbol):
        ...
        return await self._get('open/chart/symbol', False, data=data)

    async def get_kline_data_tv(self, symbol, resolution, from_time, to_time):
        ...
        return await self._get('open/chart/history', False, data=data)
    ...
    async def get_coin_list(self):
        ...
        return await self._get('market/open/coins-list')
